                ...
                Animator.prototype._setBeforeStyles = function () {
                    ...
                    try {
                        for (var elements_2 = __values(elements), elements_2_1 = elements_2.next(); !elements_2_1.done; elements_2_1 = elements_2.next()) {
                            ...
                            if (addClasses) {
                                try {
                                    for (var addClasses_1 = __values(addClasses), addClasses_1_1 = addClasses_1.next(); !addClasses_1_1.done; addClasses_1_1 = addClasses_1.next()) {
                            ...
                            if (removeClasses) {
                                try {
                                    for (var removeClasses_1 = __values(removeClasses), removeClasses_1_1 = removeClasses_1.next(); !removeClasses_1_1.done; removeClasses_1_1 = removeClasses_1.next()) {
                            ...
                            if (this._beforeStyles) {
                                try {
                                    for (var _f = __values(Object.entries(this._beforeStyles)), _g = _f.next(); !_g.done; _g = _f.next()) {
                    ...
                    try {
                        for (var elements_3 = __values(elements), elements_3_1 = elements_3.next(); !elements_3_1.done; elements_3_1 = elements_3.next()) {
                            ...
                            if (this._isReverse) {
                                ...
                                if (beforeAddClasses) {
                                    try {
                                        for (var beforeAddClasses_1 = __values(beforeAddClasses), beforeAddClasses_1_1 = beforeAddClasses_1.next(); !beforeAddClasses_1_1.done; beforeAddClasses_1_1 = beforeAddClasses_1.next()) {
                                ...
                                if (beforeRemoveClasses) {
                                    try {
                                        for (var beforeRemoveClasses_1 = __values(beforeRemoveClasses), beforeRemoveClasses_1_1 = beforeRemoveClasses_1.next(); !beforeRemoveClasses_1_1.done; beforeRemoveClasses_1_1 = beforeRemoveClasses_1.next()) {
                                ...
                                if (beforeStyles) {
                                    try {
                                        for (var _h = __values(Object.keys(beforeStyles)), _j = _h.next(); !_j.done; _j = _h.next()) {
                                ...
                                if (afterAddClasses) {
                                    try {
                                        for (var afterAddClasses_1 = __values(afterAddClasses), afterAddClasses_1_1 = afterAddClasses_1.next(); !afterAddClasses_1_1.done; afterAddClasses_1_1 = afterAddClasses_1.next()) {
                                ...
                                if (afterRemoveClasses) {
                                    try {
                                        for (var afterRemoveClasses_1 = __values(afterRemoveClasses), afterRemoveClasses_1_1 = afterRemoveClasses_1.next(); !afterRemoveClasses_1_1.done; afterRemoveClasses_1_1 = afterRemoveClasses_1.next()) {
                                ...
                                if (afterStyles) {
                                    try {
                                        for (var _k = __values(Object.entries(afterStyles)), _l = _k.next(); !_l.done; _l = _k.next()) {
