...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _pages_search_search_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./pages/search/search.module */ "./src/app/pages/search/search.module.ts");
            ...
            AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
                    ...
                    imports: [
                        ...
                        _pages_search_search_module__WEBPACK_IMPORTED_MODULE_10__["SearchPageModule"],
            ...
            SearchPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
                    imports: [
                        ...
                        _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{ path: 'search', component: _search_page__WEBPACK_IMPORTED_MODULE_6__["SearchPage"] }])
                    ],
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WordpressService = /** @class */ (function () {
                function WordpressService(http) {
                    this.http = http;
                    this.url = "https://www.basketballnetwork.net//wp-json/wp/v2/";
                ...
                WordpressService.prototype.getPostsSearch = function () {
                    var _this = this;
                    var options = {
                        observe: "response",
                        params: {}
                ...
                WordpressService.prototype.saveToFavorite = function (id) {
                    var _this = this;
                    return this.http.get(this.url + "posts/" + id + "?_embed").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) {
                        post['media_url'] = post['_embedded']['wp:featuredmedia'][0]['media_details'].sizes['medium'].source_url;
                        if (_this.favorite === undefined) {
                            _this.favorite = JSON.parse(localStorage.getItem('favoriteList'));
                            if (_this.favorite === null) {
                                _this.favorite = [];
                            }
                        }
                ...
                WordpressService.prototype.getPostContent = function (id) {
                    ...
                    return this.http.get(this.url + "posts/" + id + "?_embed").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) {
                        post['media_url'] = post['_embedded']['wp:featuredmedia'][0]['media_details'].sizes['medium'].source_url;
                        if (_this.hystory === undefined) {
                            _this.hystory = JSON.parse(localStorage.getItem('hystoryList'));
                            if (_this.hystory === null) {
                                _this.hystory = [];
                            }
                        }
                        _this.hystory.push(post);
                        _this.setStorage(JSON.stringify(_this.hystory));
                        return post;
                    }));
                };
                WordpressService.prototype.findPost = function (search) {
                    return this.http.get(this.url + "posts?search=" + search).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
                        var data = resp;
                        return data;
                    }));
                };
                WordpressService.prototype.getUser = function (id) {
                    return this.http.get(this.url + "users/?search=" + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
                        var data = resp[0];
                        return data;
                    }));
                };
                WordpressService.prototype.getCathegory = function (id) {
                    return this.http.get(this.url + "categories/" + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
                        var data = resp;
                        return data;
                    }));
                };
                WordpressService.prototype.getTagName = function (id) {
                    return this.http.get(this.url + "tags/" + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
                        var data = resp;
                        return data;
                    }));
                };
                WordpressService.prototype.getPostsByTag = function (tag) {
                    return this.http.get(this.url + "posts?tags=" + tag).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
                        var data = resp;
                        return data;
                    }));
                };
                WordpressService.prototype.getAllCategories = function () {
                    return this.http.get(this.url + "categories").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) {
                ...
                ///// Storage
                WordpressService.prototype.setStorage = function (value) {
                    var filteredValue = JSON.parse(value);
        ...
        /*! no static exports found */
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! /Users/MacPro/Desktop/DECODER/Basket/src/main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
