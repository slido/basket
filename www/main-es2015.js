...
let LoaderService = class LoaderService {
    ...
    showLoading(loadingId, loadingMessage = 'Loading data...') {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    dismissLoader(loadingId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return yield this.loadingController.dismiss(null, null, loadingId).then(() => console.log('loading dismissed'));
        });
    }
};
...
let WordpressService = class WordpressService {
    ...
    saveToFavorite(id) {
        return this.http.get(`${this.url}posts/${id}?_embed`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(post => {
            ...
            let target = this.favorite.find((temp) => temp.id == id);
            if (!target) {
    ...
    findPost(search) {
        return this.http.get(`${this.url}posts?search=${search}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(resp => {
            let data = resp;
            return data;
        }));
    }
    getUser(id) {
        return this.http.get(`${this.url}users/?search=${id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(resp => {
            let data = resp[0];
            return data;
        }));
    }
    getCathegory(id) {
        return this.http.get(`${this.url}categories/${id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(resp => {
            let data = resp;
            return data;
        }));
    }
    getTagName(id) {
        return this.http.get(`${this.url}tags/${id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(resp => {
            let data = resp;
            return data;
        }));
    }
    getPostsByTag(tag) {
        return this.http.get(`${this.url}posts?tags=${tag}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(resp => {
            let data = resp;
            return data;
        }));
    }
    getAllCategories() {
        return this.http.get(`${this.url}categories`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(resp => {
    ...
    getPostsByCategory(cat) {
        return this.http.get(`${this.url}posts?categories=${cat}&per_page=10`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(resp => {
            let data = resp;
            for (let post of data) {
